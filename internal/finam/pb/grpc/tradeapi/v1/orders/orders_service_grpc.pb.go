...
func (UnimplementedOrdersServiceServer) SubscribeOrderTrade(grpc.BidiStreamingServer[OrderTradeRequest, OrderTradeResponse]) error {
	return status.Error(codes.Unimplemented, "method SubscribeOrderTrade not implemented")
}
...
func (UnimplementedOrdersServiceServer) PlaceSLTPOrder(context.Context, *SLTPOrder) (*OrderState, error) {
	return nil, status.Error(codes.Unimplemented, "method PlaceSLTPOrder not implemented")
}
